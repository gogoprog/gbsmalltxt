...
static const unsigned char font[] = {
    ...
    // 79 O
    0x1F, 0x05, 0x05, 0x05, 0x07,
    // 80 P
    0x1F, 0x11, 0x11, 0x19, 0x1F,
    // 81 Q
    0x1F, 0x05, 0x05, 0x0D, 0x17,
    // 82 R
...
void smalltxt_draw_char(uint8 *tiles, const int x, const int y, const char index) {
    int data = font[index];
}
...
void smalltxt_render(struct smalltxt_ctx *ctx) {
    ...
    set_win_tiles(0, 0, 20, 20, ctx->tilemap);
    SHOW_WIN;
}
